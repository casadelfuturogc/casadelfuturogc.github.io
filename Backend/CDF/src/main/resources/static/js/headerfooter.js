function header(page){
    ...
    <div class="logo">
        <a href="/index.html">
            <img src="/imgs/logos/logo_cdf.svg" height="100%" alt="logo cdf">
        </a>
    </div>
    <nav class="nav">
        ...
        <a class="navitem" href="/cursos">
            <i class="fas fa-chalkboard-teacher"></i>
            <p>Cursos</p>
        </a>
        <a class="navitem" href="/eventos">
            <i class="fas fa-calendar-alt"></i>
            <p>Eventos</p>
        </a>
        <a class="navitem" href="/proyectos">
            <i class="fas fa-tools"></i>
            <p>Proyectos</p>
        </a>
        <a class="navitem" href="/contactos">
...
function footer(){
    ...
    <div class="footercont">
        <div class="logogc">
            <!-- <img src="/imgs/logos/logo_gc.svg" height="80%" alt="logo cdf"> -->
        </div>
...
function cursos( maximo){
    ...
    cursosBD = [
        ["Excel",
         ...
         "Detalle 1"],
        ["Photoshop",
         "imgs/cursos/photoshop/photoshop.jpg",
